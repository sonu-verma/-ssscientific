            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form name="productForm" id="productForm" action="{{ route('update.product') }}" method="POST" autocomplete="off">
                                {{ csrf_field() }}
                                ...
                                <div class="proposal-boxx--View">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="product_id" id="product_id" value="{{ $product->sku }}"  class="form-control fixedOption" required>
                                        </div>
                                        <div class="col-md-4">
